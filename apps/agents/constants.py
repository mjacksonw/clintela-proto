...
CRITICAL_KEYWORDS: Final[list[str]] = [
    ...
    "bleeding", "blood", "hemorrhage", "hemorrhaging",
    "fever 102", "fever 103", "fever 104", "high fever",
    "chest pain", "heart attack", "cardiac arrest",
    "can't breathe", "breathing difficulty", "shortness of breath",
    "difficulty breathing", "wheezing", "struggling to breathe",
    "unconscious", "passed out", "fainted", "blackout",
